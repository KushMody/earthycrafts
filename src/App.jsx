...
const Navbar = ({ isMenuOpen, setIsMenuOpen }) => (
  <nav className="absolute top-0 left-0 w-full pt-4 px-6 md:pt-0 md:pl-4 flex items-center justify-between z-50">
    <div className="flex items-center space-x-2">
      ...
      <div className="hidden md:flex space-x-[12px] text-lg tracking-[0.2em] font-['Forum',serif] font-normal text-white items-center">
        <Link to="/categories" className="px-1 py-1 border border-white/0 hover:border-white hover:bg-white/5 rounded-lg transition-all duration-300 whitespace-nowrap cursor-pointer">Categories</Link>
        <Link to="/all-collections" className="px-1 py-1 border border-white/0 hover:border-white hover:bg-white/5 rounded-lg transition-all duration-300 whitespace-nowrap cursor-pointer">All Collections</Link>
    ...
    <button
      ...
      className="md:hidden text-white p-2 z-[60] border border-white/20 rounded-xl bg-black/20 backdrop-blur-sm transition-all active:scale-95"
    >
...
const MobileMenu = ({ isOpen, onClose }) => (
  <div className={`fixed inset-0 bg-[#0c0c0c] z-[55] flex flex-col items-center justify-center transition-all duration-500 ease-in-out md:hidden ${isOpen ? 'translate-y-0 opacity-100' : 'translate-y-[-20px] opacity-0 pointer-events-none'}`}>
    ...
    <div className="flex flex-col space-y-12 text-center">
      <Link to="/" className="text-white text-3xl tracking-[0.3em] font-['Forum',serif] uppercase hover:text-white/60 transition-colors" onClick={onClose}>Home</Link>
      <Link to="/categories" className="text-white text-3xl tracking-[0.3em] font-['Forum',serif] uppercase hover:text-white/60 transition-colors" onClick={onClose}>Collections</Link>
      <Link to="/all-collections" className="text-white text-3xl tracking-[0.3em] font-['Forum',serif] uppercase hover:text-white/60 transition-colors" onClick={onClose}>All Collections</Link>
      <Link to="/about-us" className="text-white text-3xl tracking-[0.3em] font-['Forum',serif] uppercase hover:text-white/60 transition-colors" onClick={onClose}>About Us</Link>
      <Link to="/contact-us" className="text-white text-3xl tracking-[0.3em] font-['Forum',serif] uppercase hover:text-white/60 transition-colors" onClick={onClose}>Contact Us</Link>
    </div>
  </div>
)
