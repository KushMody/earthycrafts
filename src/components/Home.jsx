    ...
    <div className="snap-container" ref={containerRef}>
      ...
      <section className={`snap-section bg-[#0c0c0c] border-t border-white/5 ${activeSection === 2 ? 'section-visible' : ''}`}>
        <div className="grid md:grid-cols-2 h-full">
          <div className="relative p-8 md:p-32 flex flex-col justify-center">
            <div className="relative z-10 editorial-reveal" style={{ transitionDelay: '200ms' }}>
              ...
              <h2 className="text-4xl md:text-8xl font-['Forum',serif] uppercase leading-[0.9] mb-10 flex flex-col items-start drop-shadow-xl">
                <span>From <span className="text-[#c29d59]">Dust</span></span>
                <span>To Eternal</span>
              </h2>
              <p className="text-[#efe7d2]/60 text-lg md:text-xl font-['Forum',serif] leading-relaxed max-w-xl mb-16 italic">
          ...
          <div className="relative overflow-hidden group">
            ...
            <div ref={statsRef} className="absolute bottom-16 left-16 editorial-reveal opacity-0">
              <div className="flex items-center space-x-8 text-[#c29d59]">
                <span className="text-6xl md:text-9xl font-['Forum',serif]">74+</span>
                <div className="h-20 w-[1px] bg-white/20"></div>
                <span className="text-[10px] tracking-[0.6em] uppercase max-w-[100px]">Years of Stone Artistry</span>
              </div>
            </div>
          </div>
        </div>
